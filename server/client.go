...
const (
	...
	ftpUser           = "ftpuser"
	ftpPass           = "ftpuser"
	localFilePath     = "E:/workspace/go_dev/test/ftp_increment/file1.txt"
	remoteFilePath    = "/home/ftpuser/shared/file1.txt"
	offsetFilePath    = "E:/workspace/go_dev/test/ftp_increment/last_uploaded_offset.txt" // 假设这是存储最后上传偏移量的文件
	tempIncrementFile = "E:/workspace/go_dev/test/ftp_increment/increment.tmp"            // 增量数据的临时文件名
)
